    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="font-medium">
        <li class="mb-3">
          <a
            href="#"
            class="flex items-center px-2 py-3 bg-white gap-3 text-gray-900 rounded-lg hover:bg-gray-100 group"
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-person flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
            ...
            <div>
              <span class="font-bold">یعقوب خدری</span>
              <p class="text-sm opacity-70">Your acount and details</p>
            </div>
          </a>
        </li>
        <li>
          <a
            href="#"
            class="flex items-center px-2 py-3 bg-white gap-3 text-gray-900 rounded-t-lg hover:bg-gray-100 group"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
              fill="currentColor"
              class="bi bi-sliders flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
                fill-rule="evenodd"
            ...
            <span class="flex-1 whitespace-nowrap font-bold text-sm opacity-90"
              >Settings</span
            >
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <li class="mb-3">
          <a
            href="#"
            class="flex items-center px-2 py-3 bg-white gap-3 text-gray-900 rounded-b-lg hover:bg-gray-100 group"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="20"
              height="20"
              fill="currentColor"
              class="bi bi-shield-lock flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <li class="mb-3">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-question-circle flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <li>
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-gift flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <li class="mb-3">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-megaphone flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
        ...
        <li class="mb-3">
          ...
          >
            <svg
              ...
              height="20"
              fill="currentColor"
              class="bi bi-calculator flex-shrink-0 text-primary transition duration-75"
              viewBox="0 0 16 16"
            >
              <path
            ...
            <span class="flex-1 whitespace-nowrap font-bold text-sm opacity-90"
              >Calculate my potential</span
            >
            <p
              class="text-primary font-bold text-xs rounded-lg bg-green-50 py-1 px-3"
            >
              NEW
            </p>
            <svg
