<template>
  <header>
        ...
        <div class="flex items-center gap-4 [&>*]:cursor-pointer">
          <a>
            <svg
              ...
              height="16"
              fill="currentColor"
              class="bi bi-facebook transition-all hover:text-primary"
              viewBox="0 0 16 16"
            >
              <path
          ...
          <a>
            <svg
              ...
              height="16"
              fill="currentColor"
              class="bi bi-twitter transition-all hover:text-primary"
              viewBox="0 0 16 16"
            >
              <path
          ...
          <a>
            <svg
              ...
              height="16"
              fill="currentColor"
              class="bi bi-instagram transition-all hover:text-primary"
              viewBox="0 0 16 16"
            >
              <path
    ...
    <div class="border-b py-3 px-5 md:hidden">
      <a>
